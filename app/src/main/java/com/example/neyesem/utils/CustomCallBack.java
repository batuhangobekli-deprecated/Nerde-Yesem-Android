...
public class CustomCallBack<T> implements Callback<T> {
    ...
    public void onFailure(@NonNull Call<T> call, @NonNull Throwable t) {
        ...
        if(type == CustomCallBack.Type.Dialog){
            ...
            dialog.findViewById(R.id.button_dialogcustom_confirm).setOnClickListener(v -> {
                dialog.dismiss();
            ...
            customView.findViewById(R.id.imageview_loadinglayout_retry).setOnClickListener(v -> {
                deleteAllLayouts();
